#!/usr/bin/env python3
"""ultracos tee-on-failure raw-payload preservation (internal-ref).
...
def tee_on_failure(
    ...
    *,
    ...
    ``ULTRACOS_DATA_DIR`` when set) so the failing payload can be replayed
    ...
    try:
        ...
        fail_dir = ultracos_data_dir() / "failed-payloads"
