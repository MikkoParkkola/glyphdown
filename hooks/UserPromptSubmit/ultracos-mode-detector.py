#!/usr/bin/env python3
"""UltraCoS-Mode UserPromptSubmit hook.

Detects when the user's prompt activates ULTRACOS dual-mode (dense
...
TRIGGERS = (
    ...
    "internal ultracos",
    "/!:ultracos-mode",
    "stop ultracos",  # negative trigger; suppresses
)

DIRECTIVE = """\
# UltraCoS Dual-Mode Active
...
STOP_DIRECTIVE = """\
# UltraCoS Dual-Mode DEACTIVATED

For this turn forward, use normal prose in both internal reasoning
and user-visible output. Disregard any prior UltraCoS dual-register
directive.
"""
...
def main() -> int:
    try:
        ...
        print(f"ultracos-mode-detector: {e}", file=sys.stderr)
