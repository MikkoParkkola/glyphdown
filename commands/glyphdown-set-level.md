...
Set the Glyphdown skill-level intensity flag.

## Usage

```
/glyphdown-set-level <level>
```
...
```
/glyphdown-set-level lite
/glyphdown-set-level full
/glyphdown-set-level ultra
/glyphdown-set-level off
```
